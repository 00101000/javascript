    ...
    const recursion = () => {
        const orgUnits = {
            'headquaters': {
                ...
                'salePoint': {
                    'CEO': 'Name Surname of the Headquaters\'s salePoint CEO',
                    'CTO': 'Name Surname of the Headquaters\'s salePoint CTO'
                }
            },
            'branches': {
                'franceBranch': {
                    ...
                    'secondFranchOffice': {
                        'CEO': 'Name Surname of the CEO from the seconod franch office',
                        'CTO': 'Name Surname of the CTO from the seconod franch office'
                    }
                },
                'belgiumBranch': {
        ...
        console.log(`\n\nGet all nodes by level 3:`)
        getNodesByLevel(orgUnits, 3)
        console.log(`\n\nGet all employees:`)
